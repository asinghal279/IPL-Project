...
let outPath3 = path.join(__dirname,`../public/output/top10EconomicalBowlersIn${year1}.json`);
let outPath4 = path.join(__dirname,`../public/output/extraRunsPerTeamIn${year2}.json`);
...
createOutput(outPath3, JSON.stringify(top10EconomicalBowlers(matches_json,deliveries_json,year1)));
createOutput(outPath4, JSON.stringify(extraRuns(matches_json,deliveries_json,year2)));
